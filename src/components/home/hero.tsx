...
export function Hero() {
  return (
    <div className="relative mb-12 h-[40vh] min-h-80 overflow-hidden rounded-3xl bg-gradient-to-br from-purple-900 via-indigo-900 to-black text-white shadow-2xl">
